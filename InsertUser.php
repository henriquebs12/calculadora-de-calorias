...
<body class="body-home w-50 mx-auto mt-5">
    ...
    <div class="container">
      <form method="post" action="InsertUser.php" class="login" id='login'>
        <div class="form-group">
          ...
          <input required="required" type="email" id="email" name="email" class="form-control" id="exampleInputEmail1"
            aria-describedby="emailHelp" placeholder="exemplo@email.com.br">
          <small id="emailHelp" class="form-text text-muted"></small>
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Senha</label>
          <input required="required" type="password" id="senha" name="senha" class="form-control"
            id="exampleInputPassword1" placeholder="*******">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Nome</label>
          <input required="required" type="name" id="nome" name="nome" class="form-control" id="exampleInputEmail1"
            aria-describedby="emailHelp" placeholder="Seu nome">
          <small id="emailHelp" class="form-text text-muted"></small>
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Altura</label>
          <input required="required" step="0.01" type="number" id="altura" name="altura" class="form-control"
            id="exampleInputPassword1" placeholder="Em centimetros">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Peso</label>
          <input required="required" step="0.01" type="number" id="peso" name="peso" class="form-control"
            id="exampleInputPassword1" placeholder="Em quilos">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Data de nascimento</label>
          <input required="required" type="date" id="data" name="data" class="form-control" id="exampleInputPassword1"
            placeholder="Password">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Genero</label>
          <br>
          <input type="radio" required="required" id="male" name="genero" value="M">Masculino<br>
          <input type="radio" required="required" id="female" name="genero" value="F">Feminino<br>
        </div>
